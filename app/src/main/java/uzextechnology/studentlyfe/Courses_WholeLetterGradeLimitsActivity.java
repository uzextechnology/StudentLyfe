...
public class Courses_WholeLetterGradeLimitsActivity extends AppCompatActivity {

    private Student_Course LetterCourse;
    private Student_Course NumberCourse;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LetterCourse = (Student_Course)getIntent().getSerializableExtra("currentLetterCourse");
